...
#tf_nn_model, tf_nn_predictions, tf_nn_history = train_neural_network_tensorflow(dataset1, input_columns1, output_column1, num_layers, num_units1, num_epochs, learning_rate)
...
tf_nn_model, tf_nn_predictions, tf_nn_history = train_neural_network_tensorflow(dataset3, input_columns3, output_column3, num_layers, num_units3, num_epochs, learning_rate)
...
mape1 = calculate_mape(real_values, tf_nn_predictions)
print(f"MAPE for Dataset 2: {mape1:.2f}%")
...
np.savetxt("RealEstateLossTensorflow.csv", tf_nn_history.history['loss'], delimiter=",")
