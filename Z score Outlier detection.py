...
dataset1 = remove_nan_columns(dataset1)
dataset2 = remove_nan_columns(dataset2)
dataset3 = remove_nan_columns(dataset3)
...
# Keep the output column in the processed dataset if it exists
if output_column1 in dataset1.columns:
    dataset1[output_column1] = dataset1[output_column1].fillna(dataset1[output_column1].mean())
